(function(module){
  ...
  var UtPageListController = function(tableDataService, searchDataService, $http, $log) {
    var model = this;
  ...
  module.controller("UtPageListController", UtPageListController);

}(angular.module("ut.pageList")));